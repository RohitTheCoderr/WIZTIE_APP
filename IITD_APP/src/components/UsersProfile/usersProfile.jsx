...
function UsersProfile() {
    ...
    return (
        <>
            <div className="h-[100%] w-[52rem] overflow-hidden scrollbar-hide">
                <div className="h-auto">
                    <div className="relative m-auto w-[90%] bg-[#fffbfe] p-[2px] rounded-3xl h-auto py-8 ">

                        <div className="h-[12rem] w-[90%] bg-[#95D2B3]  mx-auto rounded-3xl relative">
