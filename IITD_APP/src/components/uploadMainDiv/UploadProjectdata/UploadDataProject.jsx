    ...
    return (
        <div className='border-2 h-[10rem] w-[47rem] border-green-800 bg-[#fffbfe] rounded-xl'>
            <div className=' flex justify-between rounded-2xl'>
                ...
                <NavLink
                    to={"/useraccount"}
                    className={({ isActive }) =>`h-11 w-[33.33%] rounded-tl-xl border-b-4 cursor-pointer border-gray-200 hover:border-[#55AD9B] pt-1 text-center font-semibold text-xl list-none bg-[#95D2B3] ${isActive  ? 'after:block border-[#55AD9B]' : 'after:hidden'}`}
                >
                   Add project
                </NavLink>
