    ...
    return (
        <div className=' md:w-[90vw] lg:w-[80vw] m-auto my-2 sm:my-6 md:my-[3rem]  md:flex md:justify-between '>
            <div className='w-[90vw] m-auto md:m-0 sm:w-[20rem] md:w-[15rem] sm:text-start md:text-start font-inter'>
                <div className='py-4'>
                    <div className='flex items-center gap-4 my-2'><div className='w-7 h-7 bg-[#55ab9b] rounded-[50%] flex justify-center items-center' ><FaPhoneAlt className='text-sm text-white' /></div> <span className='text-sm font-four '>call to us</span></div>
                ...
                <div>
                    <div className='flex items-center gap-4 my-4 '> <div className='w-7 h-7 bg-[#55ab9b] rounded-[50%] flex justify-center items-center' ><MdOutlineEmail className='text-base text-white' /></div> <span className='text-sm font-four '>write to us</span></div>
                    ...
                    {(values) => (
                        <Form>
                            <div className=' lg:flex lg:justify-between gap-4'>
                                <TextInput style=" sm-w[100%] border-none bg-[#ddfff8] px-1"  name="name" type="input" />
                                <TextInput style=" sm-w[100%] border-none bg-[#ddfff8] px-1"  name="email" type="input" />
                                <TextInput style=" sm-w[100%] border-none bg-[#ddfff8] px-1" type="text"  name="phone" />
                            </div>
                            <Textarea type="textarea" rows="4" cols="50"  name="textarea" style="bg-[#ddfff8] px-1 " />
